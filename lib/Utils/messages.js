...
if (quoted && !(jid && jid.includes('newsletter'))) {
...
const generateWAMessage = async (jid, content, options) => {
    ...
    // Temporary fix - manually check for newsletter JID pattern
    const isNewsletter = jid && jid.includes('newsletter');
    
  return (0, exports.generateWAMessageFromContent)(jid, await (0, exports.generateWAMessageContent)(content, { newsletter: (jid && jid.includes('newsletter')), ...options }), options);
};
